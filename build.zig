...
pub fn build(b: *std.Build) void {
    ...
    // PR-23a [feat]: MCID → text resolver tests.
    ...
    // PR-W10a [feat]: XMP /Metadata stream writer tests.
    const xmp_writer_unit_tests = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("src/xmp_writer.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
